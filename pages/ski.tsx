            ...
            >
              ...
              <Requirements
                text1={`
                  ...
                  жители
                  Северо-Восточного административного округа, имеющие 
                ...
                text2={`
                  ...
                  ❗️❗️Если вы планируете выполнять норматив по лыжным 
                  гонкам, то вам необходимо указать подтвержденный на 
                  сайте gto.ru УИН при регистрации.
                `}
                bg={"linear-gradient(90deg, #015B88 0%, #009DEC 100%)"}
              />
              <Packets
