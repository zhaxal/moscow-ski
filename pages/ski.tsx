      ...
      <div className="flex flex-col lg:flex-row mb-10">
        <p className="font-[GothamProRegular] text-[20px] leading-[20px] text-white max-w-[600px] flex flex-col gap-2">
          ...
          <span>
            ...
            медицинский допуск к участию в соревнованиях. На Лыжню России 7
            февраля допускаются участники от 18 лет, имеющие медицинский допуск
            к участию в соревнованиях. Возраст участников определяется по дате
            рождения (полных лет) по состоянию на день проведения соревнований.
          </span>
          <span>
