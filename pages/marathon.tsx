            ...
            >
              ...
              <Requirements
                text1={`Соревнования проводятся в соответствии с правилами 
                        ...
                        К участию в соревновании допускаются лыжники-любители 
                        и спортсмены субъектов Российской Федерации, ближнего и 
                        дальнего зарубежья в возрасте от 17 лет и старше, имеющие 
                        медицинский допуск к участию в соревнованиях. Возраст 
                        участников определяется по дате рождения (полных лет) по 
                        состоянию на день проведения соревнований. Участники, не 
                        прошедшие контрольные пункты по дистанции, будут 
                        дисквалифицированы, их результат аннулируется.
