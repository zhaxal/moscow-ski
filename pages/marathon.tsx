      ...
      >
        ...
        <Container disableGutters maxWidth="xl">
          <Stack direction={"column"}>
            ...
            >
              <Information
                text={`Московский лыжный марафон — это совершенно новый 
                марафон в серии Russialoppet

                Стань частью лыжного сообщества!
                Такой гонки еще не было в Москве.
                Ждем тебя 12 февраля 2023 года!
                
                Московский лыжный марафон войдет в календари Суперкубка, 
                Кубка Команд и проект «Лаки Лузер», также твой 
                результат будет включен в рейтинг финишеров.`}
                bg={"linear-gradient(90deg, #880101 0%, #EC0000 100%)"}
                isMobile={matches}
              />
              <ProgramMarathon
