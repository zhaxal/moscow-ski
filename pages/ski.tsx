          ...
          <Stack direction={"column"}>
                    ...
                    >
                      ...
                      >
                        {`«Лыжня России» — ежегодное спортивное мероприятие для любителей 
                          ...
                          только в России, но и в Европе. Каждый год на старт выходит более 500 
            ...
            >
              <Information
                ...
                Хотите встретить на страте олимпийских чемпионов, 
              ...
              <Requirements
                text1={`
                Соревнования проводятся в соответствии с правилами лыжных 
                гонок. Стиль свободный.
                К соревнованиям допускаются все желающие от 9 лет, 
                имеющие медицинский допуск к участию в соревнованиях. 
                Возраст участников определяется по дате рождения (полных 
                лет) по состоянию на день проведения соревнований.
                Участники, не прошедшие контрольные пункты по дистанции, 
                будут дисквалифицированы, их результаты аннулируются. 
                Победители определяются по наименьшему количеству 
                времени, затраченному на прохождение дистанции.
                `}
                text2={`
                  Всем участникам необходимо при себе иметь:

                  — индивидуальный (или коллективный) допуск по форме 
                  1144-н (ОБРАЗЕЦ)
                  ...
                  Иные документы не установленной формы к рассмотрению 
                  не принимаются.
                `}
                bg={"linear-gradient(90deg, #015B88 0%, #009DEC 100%)"}
              />
