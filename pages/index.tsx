  ...
  return (
    <>
      ...
      <div className="font-[GothamProMedium] text-[20px] leading-[30px] text-white pt-6">
        <p>5 марта — Ретро-гонка</p>
        <p>6 марта — Ночная лыжная гонка</p>
        <p>7 марта — день школьных соревнований</p>
        <p>8 марта — Лыжня России</p>
      </div>
    </>
  );
}
...
function ParkTwo() {
  return (
    <>
      ...
      <div className="font-[GothamProMedium] text-[20px] leading-[30px] text-white pt-6">
        <p>9 марта — 3-й Московский лыжный марафон</p>
      </div>
    </>
  );
}
